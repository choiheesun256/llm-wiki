...
This vault is organized as an LLM-assisted research wiki built on top of web clips and user questions.

## Current scope

- single-cell methods
- perturbation modeling
- annForce and related perturbation-prediction literature
...
- When does explicit dynamics help single-cell perturbation prediction?
- Which annForce baselines are the most defensible: CPA, GEARS, CellOT, or CellRank?
